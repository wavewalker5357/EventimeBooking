...
var_dump($_SESSION);
?>
 Hey,  <b><?php echo $_SESSION['user_first_name']; ?></b>
 <b><?php echo $_SESSION['user_last_name']; ?></b>. You are logged in as:
...
<b>Reservation ID: </b><?php echo $_SESSION['user_reservation']; ?>
